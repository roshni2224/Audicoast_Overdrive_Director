...
import com.example.audicoastoverdrivedirector.FileAdapter;
...
public class InternalFragment extends Fragment {
    ...
    public ArrayList<File> findFiles(File file)
    {
        ...
        for(File singleFile: files)
        {
            if( singleFile.getName().toLowerCase().endsWith(".pdf") || singleFile.getName().toLowerCase().endsWith(".txt") ||
                    singleFile.getName().toLowerCase().endsWith(".doc") || singleFile.getName().toLowerCase().endsWith(".apk") ||
                    singleFile.getName().toLowerCase().endsWith(".jpeg") || singleFile.getName().toLowerCase().endsWith(".jpg")  ||
