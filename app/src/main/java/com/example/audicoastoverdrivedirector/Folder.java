...
public class Folder extends AppCompatActivity {
    ...
    public void runtimePermission() {
        Dexter.withContext(Folder.this).withPermissions(
    ...
    public void displayFiles() {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Folder.this,1));
        fileList = new ArrayList<>();
        fileList.addAll(findFiles(storage));

        fileAdapter = new FileAdapter(Folder.this,fileList);
