...
public class Video extends AppCompatActivity {
    ...
    public void runtimePermission() {
        Dexter.withContext(Video.this).withPermissions(
    ...
    public void displayFiles() {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Video.this,1));
        fileList = new ArrayList<>();
        fileList.addAll(findFiles(storage));

        fileAdapter = new FileAdapter(Video.this,fileList);
